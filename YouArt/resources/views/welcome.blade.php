...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,400&family=Montserrat:wght@200;300;400;500&family=Noto+Naskh+Arabic:wght@400;500;600&family=Noto+Serif+SC:wght@400;500;600&family=Noto+Serif:wght@400;500;600&family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400&display=swap"
        rel="stylesheet">
    <style>
        body {
...
<body class="bg-darkBurgundy  text-cream min-h-screen">
    <!-- Minimal Header -->
    <header class="fixed w-full z-50 bg-darkBurgundy bg-opacity-50 backdrop-blur-md border-b border-gold/20">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <a href="{{ route('home') }}" class="text-2xl font-display font-light tracking-widest text-gold">You<span
                    class="text-goldLight">Art</span></a>
            <nav class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('workshops.index') }}"
                    class="nav-link text-sm text-cream font-light hover:text-gold">Workshops</a>
                @auth
                    @if (Auth::user()->role === 'artist')
                        <a href="{{ route('artist.space') }}"
                            class="nav-link text-sm text-cream font-light hover:text-gold">Artist Space</a>
                    @elseif (Auth::user()->role === 'art_lover')
                        <a href="{{ route('artlover.space') }}"
                            class="nav-link text-sm text-cream font-light hover:text-gold">My Space</a>
                    @endif
                    <form action="{{ route('logout') }}" method="POST" class="inline">
                        @csrf
                        <button type="submit"
                            class="nav-link text-sm text-cream font-light hover:text-gold bg-transparent border-0">Logout</button>
                    </form>
                @else
                    <a href="{{ route('login') }}" class="nav-link text-sm text-cream font-light hover:text-gold">Login</a>
                    <a href="{{ route('register') }}"
                        class="nav-link text-sm text-gold font-light hover:text-cream">Register</a>
                @endauth
            </nav>
    ...
    <section class="pt-36 pb-16 px-6 bg-burgundy relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-16 animate-fade-in">
                <h1 class="font-display text-5xl md:text-7xl font-bold text-gold leading-tight mb-4 text-shadow">YouArt
                </h1>
                <p class="font-script text-xl text-cream italic mb-4">A journey through the world of artistic expression
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                    ...
                    <div class="quote-card card-item gold-border p-6 animate-fade-in animation-delay-900">
                        <p class="font-cyrillic text-xl text-gold mb-2">Bienvenue dans le monde de l'art</p>
                        <p class="text-xs text-cream">Welcome to the world of art (French)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                <div class="md:col-span-5">
                    <div class="gold-border p-1 bg-darkBurgundy art-card" style="--rotate: -2deg">
                        <img src="images/the ninth wave by ivan aivazovsky.jpg" alt="The Ninth Wave by Aivazovsky"
                ...
                <div class="md:col-span-7 text-center md:text-left">
                    <p class="font-script text-2xl text-goldLight italic mb-8">"Art is not what you see, but what you
                        make others see."</p>
                    <p class="text-xs text-gold mb-2">— Edgar Degas</p>
                    <p class="text-sm text-cream mb-6">
                        Explore the profound beauty of classical masterpieces, contemporary expressions, and the
                        historical journey of human creativity. Through brushstrokes, sculptures, and visual narratives,
                        discover how art has shaped our understanding of beauty and meaning across civilizations.
                    </p>
                    <a href="#exhibitions"
                        class="inline-block px-6 py-2 border border-gold text-gold text-sm tracking-widest hover:bg-gold hover:text-darkBurgundy transition duration-300">Begin
                        Journey</a>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 px-6 relative bg-beige">
    ...
    <section id="exhibitions" class="py-20 px-6 relative bg-burgundy">
        <div class="absolute inset-0 bg-[url('https://i.imgur.com/1KkCtZZ.jpg')] opacity-5 bg-fixed bg-center bg-cover">
        </div>
        <div class="max-w-6xl mx-auto relative z-10">
            ...
            <div class="scattered-layout">
                ...
                <div class="col-span-6 md:col-span-5 row-span-2 art-card" style="--rotate: 1deg">
                    <div class="gold-border p-1">
                        <img src="images/Moscow Courtyard.jpg" alt="Moscow Courtyard"
                            class="w-full h-full object-cover">
                        <div class="p-4 bg-darkBurgundy bg-opacity-95">
                            <h3 class="font-display text-xl text-gold mb-2">Poetic Landscapes</h3>
                            <p class="text-xs text-cream mb-2">The beauty of nature captured through the eyes of the
                                Russian masters, revealing the soul of a nation through landscapes.</p>
                ...
                <div class="col-span-6 md:col-span-7 quote-card card-item gold-border p-6" style="--rotate: -1deg">
                    ...
                    <p class="text-sm text-cream mb-4">The 19th century marked the golden age of Russian painting, with
                        artists skillfully capturing the essence of Russian life and nature. Moving beyond academic
                        constraints, these artists sought to represent the nation's soul through depictions of everyday
                        landscapes, common people, and historical scenes.</p>
                    <p class="font-script text-goldLight italic">"The landscape is not merely a visual spectacle but a
                        reflection of the artist's spiritual connection to their homeland."</p>
                </div>
                ...
                <div class="col-span-6 md:col-span-6 row-span-2 art-card" style="--rotate: -1.5deg">
                    <div class="gold-border p-1">
                        ...
                        <div class="p-4 bg-darkBurgundy bg-opacity-95">
                            ...
                            <p class="text-xs text-cream mb-2">Mythical heroes and legendary tales brought to life
                                through the artistic vision of masters who preserved Russian cultural heritage.</p>
                ...
                <div class="col-span-6 md:col-span-6 row-span-2 art-card" style="--rotate: 2deg">
                    <div class="gold-border p-1">
                        <img src="images/Above Eternal Rest.jpg" alt="Above Eternal Rest"
                            class="w-full h-full object-cover">
                        <div class="p-4 bg-darkBurgundy bg-opacity-95">
                            <h3 class="font-display text-xl text-gold mb-2">Spiritual Landscapes</h3>
                            <p class="text-xs text-cream mb-2">Contemplative visions of nature that transcend mere
                                representation, inviting viewers to experience profound emotional and spiritual depths.
                            </p>
                ...
                <div class="col-span-12 md:col-span-5 art-tools gold-border p-8 flex items-end">
                    <div class="bg-darkBurgundy bg-opacity-80 p-4 gold-border">
                        ...
                        <p class="text-xs text-cream">Behind every masterpiece lies the artist's intimate relationship
                            with their tools—handcrafted brushes, pigments ground from minerals and plants, and canvases
                            prepared with traditional techniques passed down through generations.</p>
                    </div>
                </div>
                ...
                <div class="col-span-12 md:col-span-7 quote-card card-item gold-border p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <p class="font-cyrillic text-lg text-gold mb-2">"Искусство — это отражение души человека на
                                холсте времени."</p>
                            <p class="text-xs text-cream mb-4">Art is the reflection of the human soul on the canvas of
                                time. (Russian)</p>
                        </div>
                        <div>
                            <p class="font-arabic text-lg text-gold text-right mb-2">"الفن هو أعلى تعبير عن الحضارة"
                            </p>
                            <p class="text-xs text-cream text-right">Art is the highest expression of civilization.
                                (Arabic)</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-20 px-6 bg-darkBurgundy relative">
        <div
            class="absolute inset-0 bg-[url('https://i.imgur.com/zfvOda1.jpg')] opacity-5 bg-fixed bg-center bg-cover">
        </div>
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-16">
                ...
                <div class="bg-darkBurgundy p-6 md:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                        ...
                        <div class="md:col-span-5">
                            ...
                            <p class="text-sm text-cream mb-6">
                                Known as "The Forest Tsar," Ivan Shishkin is one of Russia's most beloved landscape
                                painters. His extraordinary attention to detail and technical mastery allowed him to
                                capture the Russian wilderness with unparalleled accuracy and emotional depth.
                            </p>
                            <p class="text-sm text-cream mb-6">
                                Having studied at the Moscow School of Painting and the St. Petersburg Imperial Academy
                                of Arts, Shishkin dedicated his life to depicting the majestic beauty of Russian
                                forests. His works are characterized by photographic precision, yet they transcend mere
                                reproduction, revealing his profound spiritual connection to nature.
                            </p>
                        ...
                        <div class="md:col-span-4">
                            <div class="gold-border p-1 mb-4">
                                <img src="images/Morning in a Pine Forest.jpg" alt="Morning in a Pine Forest"
                                    class="w-full">
                            </div>
                            <p class="text-xs text-goldLight text-center italic mb-6">Morning in a Pine Forest, 1889
                            </p>
                ...
                <div class="bg-darkBurgundy p-6 md:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                        ...
                        <div class="md:col-span-5 order-2">
                            ...
                            <div class="gold-divider w-16 my-4"></div>
                            <p class="text-sm text-cream mb-6">
                                Ivan Aivazovsky, a prominent Russian Romantic painter, is considered one of the greatest
                                marine artists in history. With an extraordinary memory and exceptional talent, he
                                created over 6,000 paintings during his lifetime, most depicting the sea in various
                                moods and conditions.
                            </p>
                            <p class="text-sm text-cream mb-6">
                                Born to an Armenian family in Feodosia, Crimea, Aivazovsky studied at the Imperial
                                Academy of Arts in St. Petersburg. His technical brilliance allowed him to capture the
                                translucent quality of water and the play of light on waves with remarkable
                                authenticity, often painting from memory rather than from direct observation.
                            </p>
                            <div class="font-script text-goldLight italic">
                        ...
                        <div class="md:col-span-4 order-3">
                            ...
                            <div class="gold-border p-1">
                                <img src="images/Storm on the Sea at Night.jpg" alt="Storm on the Sea at Night"
                                    class="w-full">
                            </div>
    ...
    <section class="py-12 px-6 relative bg-beige">
        <div class="max-w-6xl mx-auto">
            <div class="scattered-layout">
                <div class="col-span-12 md:col-span-5 card-item gold-border p-6 quote-card">
                    ...
                    <p class="text-sm text-cream">
                        Behind every masterpiece lies the artist's intimate relationship with their tools. From
                        handcrafted brushes to pigments ground from rare minerals, these instruments translate vision
                        into reality.
                    </p>
                </div>
    ...
    <section class="py-20 px-6 relative bg-darkBurgundy">
        <div
            class="absolute inset-0 bg-[url('https://i.imgur.com/tsnDt7p.jpg')] opacity-5 bg-fixed bg-center bg-cover">
        </div>
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-8 card-item gold-border p-1 art-card" style="--rotate: -1deg">
                    <img src="images/5_deYoungOpen_GarySexton_10_2_20_UPDATED-1024x683.webp"
                        alt="The Rooks Have Come Back" class="w-full object-cover">
                    <div class="p-4 bg-darkBurgundy">
                        ...
                        <p class="text-sm text-cream">
                            A humble yet profoundly moving depiction of early spring in Russia, this painting marks a
                            turning point in Russian landscape art. Through the simple scene of rooks returning to their
                            nests, Savrasov created what critic Pavel Tretyakov called "the very soul of Russia."
                        </p>
                    </div>
                </div>
                ...
                <div class="md:col-span-6 card-item gold-border p-1 art-card" style="--rotate: 1deg">
                    ...
                    <div class="p-4 bg-darkBurgundy">
                        ...
                        <p class="text-xs text-cream">
                            Revolutionary in its use of light, this nocturne painting created a sensation when first
                            exhibited. Using innovative techniques, Kuindzhi achieved an almost luminous quality in his
                            depiction of moonlight reflected on water.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:col-span-6 card-item gold-border p-1 art-card" style="--rotate: -1deg">
                    <img src="images/screenshot 2023-06-22 142237__73629.original.png" alt="The Rainbow"
                        class="w-full object-cover">
                    <div class="p-4 bg-darkBurgundy">
                        <h3 class="font-display text-lg text-gold">The Rainbow</h3>
                        <p class="text-xs text-goldLight mb-2">Ivan Shishkin, 1865</p>
                        <p class="text-xs text-cream">
                            This early work by Shishkin already demonstrates his impressive ability to render the
                            Russian landscape with both scientific precision and poetic sensibility. The rainbow creates
                            a symbolic bridge between heaven and earth.
                        </p>
                    </div>
                </div>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="quote-card card-item gold-border p-6 flex flex-col justify-center">
                    ...
                    <p class="text-sm text-cream">
                        The white walls of the gallery create a sacred space where art and viewer can engage in intimate
                        dialogue, free from the distractions of the outside world.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 px-6 bg-darkBurgundy relative">
        <div
            class="absolute inset-0 bg-[url('https://i.imgur.com/1KkCtZZ.jpg')] opacity-5 bg-fixed bg-center bg-cover">
        </div>
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-16">
                            ...
                            <div class="card-item gold-border p-1 workshop-item h-full">
                                <div class="relative">
                                    @if ($workshop->video_thumbnail)
                                        <img src="{{ $workshop->video_thumbnail }}" alt="{{ $workshop->title }}"
                                            class="w-full h-56 object-cover">
                                    @elseif($workshop->thumbnail_image)
                                        <img src="{{ asset('storage/' . $workshop->thumbnail_image) }}"
                                            alt="{{ $workshop->title }}" class="w-full h-56 object-cover">
                                    @else
                                    ...
                                    <div
                                        class="absolute bottom-2 right-2 bg-darkBurgundy bg-opacity-80 text-gold px-2 py-1 text-xs border border-gold">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <a href="{{ route('workshops.show', $workshop) }}"
                                            class="text-gold text-xs hover:text-cream transition-colors flex items-center">
                                            Watch now
            ...
            @else
                <div class="text-center py-16 card-item gold-border p-6">
                    <p class="font-script text-xl text-gold italic mb-2">No featured workshops available at the moment.
                    </p>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('workshops.index') }}"
                    class="inline-block px-6 py-2 border border-gold text-gold text-sm tracking-widest hover:bg-gold hover:text-darkBurgundy transition duration-300">
                    View All Workshops
                </a>
            </div>
        </div>
    ...
    <section class="py-16 px-6 relative bg-beige">
        <div class="max-w-6xl mx-auto">
            <div class="scattered-layout">
                ...
                <div class="col-span-12 md:col-span-4 quote-card card-item gold-border p-6">
                    <p class="font-cyrillic text-xl text-gold mb-2">L'art nous unit tous</p>
                    <p class="text-xs text-cream">Art unites us all (French)</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-32 px-6 relative bg-darkBurgundy">
        <div
            class="absolute inset-0 bg-[url('https://i.imgur.com/Y3wBnHS.jpg')] opacity-10 bg-fixed bg-center bg-cover">
        </div>
        <div class="max-w-4xl mx-auto relative z-10">
            <div class="card-item gold-border p-8">
                <div class="text-center">
                    ...
                    <p class="text-sm text-cream mb-8 max-w-lg mx-auto">Become part of our global family of artists and
                        enthusiasts exploring the vast world of creative expression throughout human history.</p>
                    <a href="{{ route('register') }}"
                        class="inline-block px-8 py-3 bg-gold text-darkBurgundy text-sm font-medium tracking-widest hover:bg-cream transition duration-300">Register
                        Now</a>
                </div>
            </div>
        </div>
    ...
    <footer class="py-16 px-6 bg-darkBurgundy border-t border-gold/30">
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div>
                    <a href="{{ route('home') }}"
                        class="text-2xl font-display font-light tracking-widest text-gold mb-6 inline-block">You<span
                            class="text-goldLight">Art</span></a>
                    <p class="text-cream text-sm mb-6 font-script italic">"The purpose of art is washing the dust of
                        daily life off our souls." — Pablo Picasso</p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('home') }}"
                                class="text-cream text-sm hover:text-gold transition duration-300">Home</a></li>
                        <li><a href="#"
                                class="text-cream text-sm hover:text-gold transition duration-300">Exhibitions</a></li>
                        <li><a href="#"
                                class="text-cream text-sm hover:text-gold transition duration-300">Collections</a></li>
                        <li><a href="{{ route('workshops.index') }}"
                                class="text-cream text-sm hover:text-gold transition duration-300">Workshops</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('terms') }}"
                                class="text-cream text-sm hover:text-gold transition duration-300">Terms of Service</a>
                        </li>
                        <li><a href="{{ route('privacy') }}"
                                class="text-cream text-sm hover:text-gold transition duration-300">Privacy Policy</a>
                        </li>
                    </ul>
                </div>
            </div>
